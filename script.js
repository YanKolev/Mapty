...
class Workout {
    ...
    constructor(coords, distance, duration){
        ...
        this.coords = coords; // array of attitude and longitude [lat, log]
...
class Cycling extends Workout {
    ...
    constructor (coords, distance, duration, elevationGain) {
        ...
        this.calcSpeed(); //its ok to call a method in the constructor, AS LONG as its not written inside / needs to be outside
    }
...
class App {
    ...
    _newWorkout (e) {
        ...
        if (type === 'running'){
            ...
            //using guard clause- checking for the oposite of what we are loking for
            if(
